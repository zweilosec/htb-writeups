...
first try [http://10.10.10.170](http://10.10.10.170) 

![](../.gitbook/assets/1-error.png)

\(discovered username & hostname from png on default webpage -&gt; MrR3boot@player2.htb\) hmmm...says firefox...and I am not using firefox. This is an image.

add to /etc/hosts 10.10.10.170 player2.htb 10.10.10.170 product.player2.htb

[http://player2.htb](http://player2.htb) found website - 

![](../.gitbook/assets/2-first-site.png)

link to: At [http://product.player2.htb/](http://product.player2.htb/) found a login page
